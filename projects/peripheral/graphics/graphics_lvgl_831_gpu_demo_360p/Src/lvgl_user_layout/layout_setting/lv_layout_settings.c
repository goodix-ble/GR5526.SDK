...
{
    lv_obj_t *p_window = lv_layout_setting_create_common_title(parent, &lv_font_montserrat_30, "Setting");
    ...
    lv_obj_set_style_text_font(p_list, &lv_font_montserrat_30, LV_STATE_DEFAULT);
