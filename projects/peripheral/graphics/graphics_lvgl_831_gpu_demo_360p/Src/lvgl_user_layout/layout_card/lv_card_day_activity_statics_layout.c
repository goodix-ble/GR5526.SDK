...
lv_obj_t *lv_card_day_activity_layout_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_pos(_day_walk_step_img, 110, 75);

    _day_walk_step_val = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_walk_step_val, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_walk_step_val, 150, 75);

    _day_walk_step_unit = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_walk_step_unit, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_walk_step_unit, 210, 75);

    /* sports time per day */
    _day_sports_time_img = lv_img_create(g_card_day_activity_win);
    lv_img_set_src(_day_sports_time_img, &wd_img_day_sports);
    lv_obj_set_pos(_day_sports_time_img, 110, 155);

    _day_sports_time_val = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_sports_time_val, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_sports_time_val, 150, 155);

    _day_sports_time_unit = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_sports_time_unit, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_sports_time_unit, 210, 155);

    /* stand time per day */
    _day_standup_time_img = lv_img_create(g_card_day_activity_win);
    lv_img_set_src(_day_standup_time_img, &wd_img_day_running);
    lv_obj_set_pos(_day_standup_time_img, 110, 235);

    _day_standup_time_val = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_standup_time_val, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_standup_time_val, 150, 235);

    _day_standup_time_unit = lv_label_create(g_card_day_activity_win);
    lv_obj_set_style_text_font(_day_standup_time_unit, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(_day_standup_time_unit, 210, 235);


    /* ARC : Step */
    _day_walk_step_process_arc = lv_arc_create(g_card_day_activity_win);

    lv_obj_set_size(_day_walk_step_process_arc, DISP_HOR_RES, DISP_VER_RES);
    ...
    lv_obj_set_style_arc_width(_day_walk_step_process_arc, 20, LV_PART_INDICATOR);
    lv_obj_set_style_arc_width(_day_walk_step_process_arc, 20, LV_PART_MAIN);

    /* ARC : Sports */
    _day_sports_time_process_arc = lv_arc_create(g_card_day_activity_win);

    lv_obj_set_size(_day_sports_time_process_arc, DISP_HOR_RES, DISP_VER_RES);
    ...
    lv_obj_set_style_arc_width(_day_sports_time_process_arc, 20, LV_PART_INDICATOR);
    lv_obj_set_style_arc_width(_day_sports_time_process_arc, 20, LV_PART_MAIN);

    /* ARC : Standup time */
    _day_standup_time_process_arc = lv_arc_create(g_card_day_activity_win);

    lv_obj_set_size(_day_standup_time_process_arc, DISP_HOR_RES, DISP_VER_RES);
    ...
    lv_obj_set_style_arc_width(_day_standup_time_process_arc, 20, LV_PART_INDICATOR);
    lv_obj_set_style_arc_width(_day_standup_time_process_arc, 20, LV_PART_MAIN);
