...
#define WEATHER_TITLE_X (122)
#define WEATHER_TITLE_Y (20)
#define WEATHER_ICON_X (95)
#define WEATHER_ICON_Y (58)
#define WEATHER_VAL_X (156)
#define WEATHER_VAL_Y (62)
#define WEATHER_LABEL_X (138)
#define WEATHER_LABEL_Y (120)
#define WEATHER_LINE_X (20)
#define WEATHER_LINE_Y (160)
#define WEATHER_FUTURE_DATE0_X (55)
#define WEATHER_FUTURE_DATE0_Y (169)
#define WEATHER_FUTURE_DATE1_X (154)
#define WEATHER_FUTURE_DATE1_Y (169)
#define WEATHER_FUTURE_DATE2_X (255)
#define WEATHER_FUTURE_DATE2_Y (169)
#define WEATHER_FUTURE_ICON0_X (52)
#define WEATHER_FUTURE_ICON0_Y (201)
#define WEATHER_FUTURE_ICON1_X (152)
#define WEATHER_FUTURE_ICON1_Y (201)
#define WEATHER_FUTURE_ICON2_X (252)
#define WEATHER_FUTURE_ICON2_Y (201)
#define WEATHER_FUTURE_VAL0_X (46)
#define WEATHER_FUTURE_VAL0_Y (268)
#define WEATHER_FUTURE_VAL1_X (146)
#define WEATHER_FUTURE_VAL1_Y (268)
#define WEATHER_FUTURE_VAL2_X (246)
#define WEATHER_FUTURE_VAL2_Y (268)
...
lv_obj_t *lv_card_layout_weather_create(lv_obj_t *parent_tv_obj)
{
    ...
    lv_obj_set_style_text_font(p_title, &lv_font_montserrat_26, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_weather_label, &lv_font_montserrat_26, LV_STATE_DEFAULT);
    ...
    // Dividing Line
    static lv_point_t line_pts[] = {{0, 0}, {320, 0}};
    ...
    lv_obj_set_style_text_font(_future_date[0], &lv_font_montserrat_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_future_temp_val[0], &lv_font_montserrat_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_future_date[1], &lv_font_montserrat_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_future_temp_val[1], &lv_font_montserrat_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_future_date[2], &lv_font_montserrat_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_future_temp_val[2], &lv_font_montserrat_20, LV_STATE_DEFAULT);
