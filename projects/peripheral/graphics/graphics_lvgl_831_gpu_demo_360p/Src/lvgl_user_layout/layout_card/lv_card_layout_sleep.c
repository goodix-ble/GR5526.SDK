...
lv_obj_t *lv_card_layout_sleep_create(lv_obj_t *parent_tv_obj)
{
    ...
    lv_obj_set_style_text_font(_label_sleep_hour_val, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_label_sleep_hour_unit, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_label_sleep_min_val, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(_label_sleep_min_unit, &lv_font_msyh_26_gr552x, LV_STATE_DEFAULT);
