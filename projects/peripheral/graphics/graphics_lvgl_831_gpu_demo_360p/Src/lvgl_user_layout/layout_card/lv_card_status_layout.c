...
#define LINK_ICON_X (166)
#define LINK_ICON_Y (12)
#define TIME_LABEL_X (55)
#define TIME_LABEL_Y (60)
#define DATE_LABEL_X (200)
#define DATE_LABEL_Y (58)
#define WEEK_LABEL_X (200)
#define WEEK_LABEL_Y (80)
#define BAT_ICON_X (245)
#define BAT_ICON_Y (60)
#define BAT_VAL_X (245)
#define BAT_VAL_Y (80)
#define PANEL_X (0)
#define PANEL_Y (120)
#define TABLE_1_X (0)
#define TABLE_1_Y (0)
#define TABLE_2_X (360)
#define TABLE_2_Y (0)

#define ROW1_COL1_X (14)
#define ROW1_COL1_Y (8)
#define ROW1_COL2_X (14+100)
#define ROW1_COL2_Y (8)
#define ROW1_COL3_X (14+200)
#define ROW1_COL3_Y (8)
#define ROW2_COL1_X (14)
#define ROW2_COL1_Y (108)
#define ROW2_COL2_X (14+100)
#define ROW2_COL2_Y (108)
#define ROW2_COL3_X (14+200)
#define ROW2_COL3_Y (108)
