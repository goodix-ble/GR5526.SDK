...
lv_obj_t * lv_card_watchface_vivid_layout_create(lv_obj_t * parent) {
    ...
    lv_obj_set_size(_s_btn_date, 80, 80);
    lv_obj_set_pos(_s_btn_date, 180 - 40, 100 - 40);

    _s_label_date = lv_label_create(_s_btn_date);
    lv_obj_center(_s_label_date);
    lv_obj_set_style_text_font(_s_label_date, &lv_font_msyh_20_gr552x, LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(_s_btn_alarm, 80, 80);
    lv_obj_set_pos(_s_btn_alarm, 100 - 40, 180 - 40);

    _s_img_alarm = lv_img_create(_s_vivid_clock_win);
    lv_img_set_src(_s_img_alarm, &wd_img_vivid_clock_alarm);
    lv_obj_set_pos(_s_img_alarm, 100 - wd_img_vivid_clock_alarm.header.w/2, 180 - wd_img_vivid_clock_alarm.header.h/2);

    /* timer layout*/
    _s_btn_timer = lv_btn_create(_s_vivid_clock_win);
    lv_obj_set_size(_s_btn_timer, 80, 80);
    lv_obj_set_pos(_s_btn_timer, 260 - 40, 180 - 40);
    ...
    lv_obj_set_pos(_s_img_timer, 260 - wd_img_vivid_clock_counter.header.w/2, 180 - wd_img_vivid_clock_counter.header.h/2);

    /* music layout*/
    _s_btn_music = lv_btn_create(_s_vivid_clock_win);
    lv_obj_set_size(_s_btn_music, 80, 80);
    lv_obj_set_pos(_s_btn_music, 180 - 40, 260 - 40);
    ...
    lv_obj_set_pos(_s_img_music, 180 - wd_img_vivid_clock_music.header.w/2, 260 - wd_img_vivid_clock_music.header.h/2);

    /* N*45 degree layout */
    _s_img_hr   = lv_img_create(_s_vivid_clock_win);
    lv_img_set_src(_s_img_hr, &wd_img_vivid_clock_hr_copy);
    lv_obj_set_pos(_s_img_hr, 100 - wd_img_vivid_clock_hr_copy.header.w/2, 100 - wd_img_vivid_clock_hr_copy.header.h/2);
    ...
    lv_obj_set_pos(_s_img_step, 260 - wd_img_vivid_clock_step.header.w/2, 100 - wd_img_vivid_clock_step.header.h/2);
    ...
    lv_obj_set_pos(_s_img_batery, 100 - wd_img_vivid_clock_battery_copy.header.w/2, 260 - wd_img_vivid_clock_battery_copy.header.h/2);
    ...
    lv_obj_set_pos(_s_img_energy, 260 - wd_img_vivid_clock_energy.header.w/2, 260 - wd_img_vivid_clock_energy.header.h/2);
    ...
    lv_obj_set_pos(_s_label_hr, 55, 65);
    ...
    lv_obj_set_pos(_s_label_step, 260, 70);
    ...
    lv_obj_set_pos(_s_label_battery, 55, 275);
    ...
    lv_obj_set_pos(_s_label_energy, 260,275);
