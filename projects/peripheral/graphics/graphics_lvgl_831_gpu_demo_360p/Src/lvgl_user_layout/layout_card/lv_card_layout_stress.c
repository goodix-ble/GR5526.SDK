...
#define STRESS_TITLE_X (140)
#define STRESS_TITLE_Y (20)
#define STRESS_ICON_X (83)
#define STRESS_ICON_Y (56)
#define STRESS_VAL_X (148)
#define STRESS_VAL_Y (56)
#define STRESS_LEVEL_X (215)
#define STRESS_LEVEL_Y (66)
#define STRESS_MEAS_TIME_X (108)
#define STRESS_MEAS_TIME_Y (110)

#define STRESS_CHART_LEFT_PAD (7)
#define STRESS_CHART_BOTTOM_PAD (28)
#define STRESS_CHART_X_SPACING (12)
#define STRESS_CHART_X (34)
#define STRESS_CHART_Y (150)
#define STRESS_CHART_Y_MAX_TICKS_X (322)
#define STRESS_CHART_Y_MAX_TICKS_Y (140)
#define STRESS_CHART_Y_MIN_TICKS_X (326)
#define STRESS_CHART_Y_MIN_TICKS_Y (242)

#define STRESS_MAX_ICON_X (85)
#define STRESS_MAX_ICON_Y (298)
#define STRESS_MAX_VAL_X (110)
#define STRESS_MAX_VAL_Y (290)
#define STRESS_MIN_ICON_X (215)
#define STRESS_MIN_ICON_Y (298)
#define STRESS_MIN_VAL_X (240)
#define STRESS_MIN_VAL_Y (290)
...
lv_obj_t *lv_card_layout_stress_create(lv_obj_t *parent_tv_obj)
{
    ...
    lv_obj_set_style_text_font(_stress_title, &lv_font_montserrat_26, LV_STATE_DEFAULT); // 30
    ...
    lv_obj_set_style_text_font(_stress_level, &lv_font_montserrat_26, LV_STATE_DEFAULT); // 30
